 ...
 * one, and these are where that move puts every joint. They are WRITTEN
 * here by scripts/sync-measured-manifest.mjs from what the build
 * measured, and held to the built asset by a test — because a joint the
 * schema places anywhere other than where the mesh put it is a hand in
 * the wrong place for every pose ever written, and they used to travel
 * between the two by a person copying a console dump.
 */
const HUMAN_BACK_ARM_POSITIONS: Record<string, Vec3> = {
  // <measured humanoid.body.human4 backArmRest> generated by scripts/sync-measured-manifest.mjs
  "arm.backLeft.upper": [0.11738, 0.03491, -0.00107],
  "arm.backLeft.forearm": [-0.00532, -0.14922, 0],
  "arm.backLeft.hand": [-0.02319, -0.1437, 0],
  "arm.backLeft.hand.thumb.01": [0.01411, -0.02247, -0.00572],
  "arm.backLeft.hand.thumb.02": [0.01007, -0.01203, 0.00975],
  "arm.backLeft.hand.thumb.03": [0.01017, -0.01896, 0.00478],
  "arm.backLeft.hand.index.01": [0.01475, -0.05877, -0.02126],
  "arm.backLeft.hand.index.02": [0.00161, -0.01544, -0.00203],
  "arm.backLeft.hand.index.03": [0.0004, -0.014, 0.001],
  "arm.backLeft.hand.middle.01": [-0.00045, -0.05651, -0.02501],
  "arm.backLeft.hand.middle.02": [-0.00363, -0.01995, -0.00217],
  "arm.backLeft.hand.middle.03": [-0.00211, -0.01625, 0.0002],
  "arm.backLeft.hand.ring.01": [-0.01202, -0.05241, -0.02501],
  "arm.backLeft.hand.ring.02": [-0.00611, -0.01669, -0.00253],
  "arm.backLeft.hand.ring.03": [-0.00403, -0.01438, -0.00025],
  "arm.backLeft.hand.little.01": [-0.02341, -0.04773, -0.02126],
  "arm.backLeft.hand.little.02": [-0.00567, -0.01155, -0.00074],
  "arm.backLeft.hand.little.03": [-0.00365, -0.00854, 0.00097],
  "arm.backRight.upper": [-0.11738, 0.03491, -0.00107],
  "arm.backRight.forearm": [0.00532, -0.14922, 0],
  "arm.backRight.hand": [0.02319, -0.1437, 0],
  "arm.backRight.hand.thumb.01": [-0.01411, -0.02247, -0.00572],
  "arm.backRight.hand.thumb.02": [-0.01007, -0.01203, 0.00975],
  "arm.backRight.hand.thumb.03": [-0.01017, -0.01896, 0.00478],
  "arm.backRight.hand.index.01": [-0.01475, -0.05877, -0.02126],
  "arm.backRight.hand.index.02": [-0.00161, -0.01544, -0.00203],
  "arm.backRight.hand.index.03": [-0.0004, -0.014, 0.001],
  "arm.backRight.hand.middle.01": [0.00045, -0.05651, -0.02501],
  "arm.backRight.hand.middle.02": [0.00363, -0.01995, -0.00217],
  "arm.backRight.hand.middle.03": [0.00211, -0.01625, 0.0002],
  "arm.backRight.hand.ring.01": [0.01202, -0.05241, -0.02501],
  "arm.backRight.hand.ring.02": [0.00611, -0.01669, -0.00253],
  "arm.backRight.hand.ring.03": [0.00403, -0.01438, -0.00025],
  "arm.backRight.hand.little.01": [0.02341, -0.04773, -0.02126],
  "arm.backRight.hand.little.02": [0.00567, -0.01155, -0.00074],
  "arm.backRight.hand.little.03": [0.00365, -0.00854, 0.00097],
  // </measured humanoid.body.human4 backArmRest>
};
