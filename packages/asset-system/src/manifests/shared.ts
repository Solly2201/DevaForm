...
export const SHARED_ASSETS: readonly AssetDefinition[] = [
  {
    ...
    // Everything below is MEASURED off the built GLB. Regenerate with
    // apps/web/scripts/sync-measured-manifest.mjs after rebuilding the
    // body; never edit by hand. A test holds this to the built asset,
    // because a drifted measurement fits ornaments to a body that no
    // longer exists and says nothing about it.
    // <measured humanoid.body.human> generated by scripts/sync-measured-manifest.mjs
    geometry: {
      triangles: 27816,
      vertices: 14444,
      boundsM: [0.34692, 1, 0.16651],
    },
    morphTargets: [
      "bodyLean",
      "bodyAthletic",
