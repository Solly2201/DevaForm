...
export const SHIVA_ASSETS: readonly AssetDefinition[] = [
  // ---- BODY -------------------------------------------------------------
  {
    ...
    version: 1,
    name: "Classic Body",
    description: "Balanced yogic build — broad shoulders, taut waist.",
    kind: { type: "part", slot: "body" },
    deityCompatibility: ["shiva"],
    stage: "prototype",
    source: { kind: "procedural", generatorId: "humanoid.body", params: { belly: -0.35, chest: 1.2 } },
  ...
  },
  {
    ...
    deityCompatibility: ["shiva"],
    stage: "prototype",
    source: { kind: "procedural", generatorId: "humanoid.body", params: { belly: -0.7, chest: 0.95 } },
    materialZones: ["skin", "skinSecondary"],
    category: "body",
    printability: proto,
  },
  {
    ...
    deityCompatibility: ["shiva"],
    stage: "prototype",
    source: { kind: "procedural", generatorId: "humanoid.body", params: { belly: 0, chest: 1.35 } },
    materialZones: ["skin", "skinSecondary"],
    category: "body",
    printability: proto,
  },
  ...
  // ---- EYES -------------------------------------------------------------
  {
    ...
    source: {
      ...
      params: {
        lidCover: 1.42, gazeDown: 0.22, shapeX: 1.12, shapeY: 0.76, kohl: 1, iris: 1.2,
        // Placement on the Shiva head's brow surface (head-joint-local).
        baseY: 0.003, baseZ: 0.084, spacing: 0.034, eyeScale: 0.72, splay: 0.16,
      },
    },
  ...
  },
  {
    ...
    source: {
      ...
      generatorId: "humanoid.eyes",
      params: {
        lidCover: 1.0, gazeDown: 0.1, shapeX: 1.05, shapeY: 0.95, kohl: 1, iris: 1.1,
        baseY: 0.003, baseZ: 0.084, spacing: 0.034, eyeScale: 0.72, splay: 0.16,
      },
    },
    materialZones: ["skinSecondary"],
